...
#include <memory>
#include "../QT-GUI/core/audio/audioengine.h"
...
QT_MOC_LITERAL(1, 12, 14), // "inputDeviceSig"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17), // "QVector<QString>&"
QT_MOC_LITERAL(4, 46, 13) // "m_inputDevice"

    },
    "AudioEngine\0inputDeviceSig\0\0"
    "QVector<QString>&\0m_inputDevice"
};
...
void AudioEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->inputDeviceSig((*reinterpret_cast< QVector<QString>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AudioEngine::*)(QVector<QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioEngine::inputDeviceSig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioEngine::inputDeviceSig(QVector<QString> & _t1)
{
