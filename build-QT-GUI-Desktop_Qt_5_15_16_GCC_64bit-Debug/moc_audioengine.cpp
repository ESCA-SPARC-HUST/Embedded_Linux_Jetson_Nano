...
QT_MOC_LITERAL(1, 12, 11), // "inputDevice"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16), // "QVector<QString>"
QT_MOC_LITERAL(4, 42, 13) // "m_inputDevice"

    },
    "AudioEngine\0inputDevice\0\0QVector<QString>\0"
    "m_inputDevice"
};
...
void AudioEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->inputDevice((*reinterpret_cast< const QVector<QString>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (AudioEngine::*)(const QVector<QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioEngine::inputDevice)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioEngine::inputDevice(const QVector<QString> & _t1)
{
